...
/**
 * Represents a new movie definition, which has not been inserted into the
 * database yet. Generally will be returned from the data scraper.
 * 
 * @author Jake Bellotti
 * @date 4-May-2016
 *
 */
public class NewMovieDefinition {
	...
	public NewMovieDefinition(String title, int year, String rated, String released, String runtime, String genre,
