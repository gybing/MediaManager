...
public class PresentationViewController {
	...
	/**
	 * Allows the user to select how they want to view the movie list, for example text with a thumbnail or just text.
	 */
    @FXML
    ...
    /**
     * Resets or gets rid of all of the search filters applied to this movie list.
     */
    @FXML
    private Button resetFiltersButton;
    /**
     * Opens up the filter management screen so the user can apply or remove filters.
     */
    @FXML
    ...
    /**
     * The label at the top of the screen that has the movie name and release year
     */
    @FXML
    private Label movieNameLabel;
    /**
     * Displays all the movie information like runtime, release date, rating etc.
     */
    @FXML
    ...
    /**
     * A button that will clear the user's input in the search box.
     */
    @FXML
